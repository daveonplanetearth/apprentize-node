  ...
  return (
    <section className="relative pt-28 pb-20 sm:pt-32 sm:pb-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-5 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/90 glossy-pill px-4 py-2 text-sm font-bold uppercase tracking-wide text-safety animate-fade-up">
        ...
        <h1 className="mt-6 font-display font-extrabold text-ink text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight animate-fade-up" style={{ animationDelay: '0.05s', opacity: 0 }}>
        ...
        <form onSubmit={handleSearch} className="mt-8 max-w-lg mx-auto animate-fade-up" style={{ animationDelay: '0.15s', opacity: 0 }}>
          <div className="flex flex-col sm:flex-row gap-2 bubble-card p-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full glossy-button text-white font-semibold px-6 py-3.5 text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
            >
