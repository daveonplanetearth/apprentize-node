        ...
        <div className="p-5 sm:p-6">
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              <li
                key={job.role}
                className="group flex items-start gap-3 p-3 rounded-xl border border-line/70 hover:border-ink/30 hover:bg-paper-deep/40 transition-all cursor-pointer animate-slide-in"
          ...
          <button className="mt-4 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-ink text-paper text-sm font-semibold py-3 hover:bg-ink/90 transition-colors">
